...
<body ng-app="m" ng-init='index = "公司文档管理"'>
...
<div ng-controller="c" class="container" style="width: 98%;">
            ...
            <div class="clearfix">
                <label>
                    <button class="btn btn-success pull-left" ng-click="entity._openModal()">
                        <span class="icon-plus m-r"></span>上传&nbsp;文档
                    </button>
                </label>
    ...
    <div entity-modal="modal-edit" title="编辑 文档信息" action="edit" entity="entityEdit">
        <entity-modal-body>
            <div entity-edit-text="docItem" type="text" title="文档标题" entity="entityEdit.entity"
                 e="entityEdit" ></div>
            <div entity-edit-text="introduce" type="text" title="文档简介" entity="entityEdit.entity" 
            	 e="entityEdit" ></div>
        </entity-modal-body>
    </div>
        ...
        $scope.operations = [
            {
                ...
                click: function (row) {
                	$scope.loadObj = row;
                    console.log("文件外链: " + $scope.loadObj.avatar);
                    window.location = $scope.loadObj.avatar;
                }
            }
        ];
        ...
        $scope.entityEdit = entity.getEntity(
            {	
                ...
                ajax.ajax("/document/updateOneDocument", "GET", {
                    id: $scope.editObj.id,
                    docItem: $scope.entityEdit.entity.docItem,
