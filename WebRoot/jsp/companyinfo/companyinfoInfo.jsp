...
<body ng-app="m" ng-init='index = "公司信息"'>
    ...
    <div class="panel panel-info m-t-lg" style="padding: 20px;">
		...
		<div class="row" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" ng-model="companyinfo.introduce" class="form-control" disabled style="background-color: white;" />
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" ng-model="companyinfo.address" class="form-control" disabled style="background-color: white;" />
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" ng-model="companyinfo.phone" class="form-control" disabled style="background-color: white;" />
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 20px;">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" ng-model="companyinfo.postcode" class="form-control" disabled style="background-color: white;" />
                </div>
            </div>
        </div>
            ...
            $scope.getOneCompanyInfo = function () {
                ajax.ajax("/companyinfo/getOneCompanyInfo", "GET", {
                    ...
                    if(data.success){
                        ...
                        //$scope.communityinfo = angular.copy($scope.userOrigin);
