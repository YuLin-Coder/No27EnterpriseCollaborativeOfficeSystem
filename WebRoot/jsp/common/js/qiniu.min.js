        ...
        !function (e, t) {
            ...
            n("moxie/core/utils/Basic", [], function () {
                ...
                function a() {
                    ...
                    i.extend(this, {
                        init: function (u) {
                            ...
                            var t = this.getRuntime(), i = t.getShim(), o = t.getShimContainer(), s = e && n.get(e.container), u = e && n.get(e.browse_button);
                ...
                function l() {
                    ...
                    t.extend(this, {
                        send: function (i, r) {
                            var a = this, c = "Mozilla" === u.browser && u.verComp(u.version, 4, ">=") && u.verComp(u.version, 7, "<"), h = "Android Browser" === u.browser, m = !1;
                ...
                function t(e, t) {
                    var i = e.width, n = e.height, r = Math.floor(i * t), o = Math.floor(n * t), s = document.createElement("canvas");
                ...
                function c() {
                    ...
                    function h(e, i) {
                        var n = Math.PI / 180, r = document.createElement("canvas"), o = r.getContext("2d"), s = e.width, a = e.height;
                ...
                function a() {
                    ...
                    i.extend(this, {
                        init: function (t) {
                            ...
                            var e = this.getRuntime(), t = e.getShim(), i = e.getShimContainer(), o = u && n.get(u.container), s = u && n.get(u.browse_button);
    ...
    !function (global) {
        ...
        function QiniuJsSDK() {
            ...
            this.resetUploadUrl = function (e) {
                ...
                var rx_dangerous = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, text = String(data);
                ...
                return m.bind("Error", function (t) {
                    return function (i, n) {
                        ...
                        if (i.refresh(), !e.disable_statistics_report) {
                            ...
                            console.log(n);
                            var f = p[2].replace(/[\r\n]/g, ""), h = plupload.HTTP_ERROR ? n.status : n.code, g = u._start_at ? u._start_at.getTime() : r.getTime();
